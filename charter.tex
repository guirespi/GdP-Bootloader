...
\begin{figure}[htpb]
\centering 
\includegraphics[width=.85\textwidth]{./Figuras/bootloader-flow.png}
...
Propuesta de valor: Añadir driver de memoria flash intercambiable por la compañía, particionamiento y chequeo de integridad definido por la empresa, ejecución de aplicaciones binarias guardadas para cada familia de microcontrolador agregada. Seguir buenas tecnicas de programación para facilitar la migración hacia nuevas familias y receptar nuevos requerimientos.

Diagrama de bloques

\begin{itemize}
	\item Descripcion funcional. ¿Condiciones funcionales?. Buscar comparar con el estado de arte (Con bootloaders) (¿De qué manera destaca?). Tal vez ejemplos de bootloaders de otros microcontroladores. [Falta]
	\item Qué valora el cliente? [Falta]
\end{itemize}
