...
¿De que se trata el proyecto y cuales son sus desafíos? ¿Motivación para realizarlo y su importancia?

Estado del arte.
Describir la propuesta de valor.
Que problema se atiende y la solución que se propone.
Descripción funcional.
Existen condiciones especiales del proyecto.
¿Cómo se compara la solución propuesta con el estado del arte en el campo de aplicación? ¿En qué aspectos destaca?
¿En qué estado del cliclo de vida está la solución que se propone?
¿Qué valora el cliente?



\begin{itemize}
	\item Bootloader. (https://beningo.com/wp-content/uploads/images/Papers/bootloader_design_for_microcontrollers_in_embedded_systems%20.pdf)
	\begin{itemize}
		\item ¿Qué hace un bootloader? (https://www.researchgate.net/profile/Barry-Nauta/publication/265323393_Bootloaders_-an_introduction/links/5a659ebb0f7e9b6b8fdc1bd7/Bootloaders-an-introduction.pdf)(https://sci-hub.se/https://ieeexplore.ieee.org/abstract/document/9339147)
		\item Gráfico de la solución. (Podría ser el del documento)
	\end{itemize}
	\item Restricciones del mercado norte-americano. (https://cnnespanol.cnn.com/2022/10/31/analisis-restricciones-ee-uu-microchips-ambiciones-china-trax)
	\item Por que escoger ARM en nuestra aplicación. (Libro de ARM tal vez)
	
	\item Contexto de Easymetering. ¿Por qué expandirse? (De que se trata el proyecto, motivación)
	\item Problemática: Microcontroladores ESP. Ligarlo a restricciones.
	\item Solución propuesta.
	\item Descripcion funcional. ¿Condiciones funcionales?. Buscar comparar con el estado de arte (Con bootloaders) (¿De qué manera destaca?). Tal vez ejemplos de bootloaders de otros microcontroladores.
	\item Estado de la solución. (En teoría tenemos bosquejos no más, un sistema especifico para el ESP32).
	\item Qué valora el cliente?
\end{itemize}
...
Por ejemplo:
\begin{itemize}
	\item Orientador: El \supname tiene una larga trayectoria como desarrollador de firmware y hardware. Tiene experiencia usando varios microcontroladores.
\end{itemize}
